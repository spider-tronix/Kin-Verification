    ...
    for name, param in weights.items():
        if name in own_state:
            try:
                ...
                print(f"While copying the parameter named {name}, whose dimensions in the model are {own_state[name].size()} and whose dimensions in the checkpoint are {param.size()}.")
